      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.modalOverlay}>
        ...
        <ScrollView>
          <View style={[styles.modalContent, { width: modalWidth, alignSelf: 'center' }]}>
            ...
            <TextInput
              style={styles.modalInput} value={form.studentNumber} onChangeText={(v) => setField('studentNumber', v)}
              placeholder="مثال: STU001" placeholderTextColor={colors.textTertiary} textAlign="right"
            />

            <Text style={styles.label}>الرقم الجامعي</Text>
            <TextInput
              style={styles.modalInput} value={form.universityId} onChangeText={(v) => setField('universityId', v)}
              placeholder="الرقم الجامعي" placeholderTextColor={colors.textTertiary} textAlign="right"
            />

            <Text style={styles.label}>الاسم الأول *</Text>
            <TextInput
              style={styles.modalInput} value={form.firstName} onChangeText={(v) => setField('firstName', v)}
              placeholder="الاسم الأول" placeholderTextColor={colors.textTertiary} textAlign="right"
            />

            <Text style={styles.label}>الاسم الأوسط</Text>
            <TextInput
              style={styles.modalInput} value={form.secondName} onChangeText={(v) => setField('secondName', v)}
              placeholder="الاسم الأوسط" placeholderTextColor={colors.textTertiary} textAlign="right"
            />

            <Text style={styles.label}>اسم العائلة *</Text>
            <TextInput
              style={styles.modalInput} value={form.lastName} onChangeText={(v) => setField('lastName', v)}
              placeholder="اسم العائلة" placeholderTextColor={colors.textTertiary} textAlign="right"
            />
            ...
            <TextInput
              style={styles.modalInput} value={form.college} onChangeText={(v) => setField('college', v)}
              placeholder="الكلية" placeholderTextColor={colors.textTertiary} textAlign="right"
            />

            <Text style={styles.label}>القسم</Text>
            <TextInput
              style={styles.modalInput} value={form.department} onChangeText={(v) => setField('department', v)}
              placeholder="القسم" placeholderTextColor={colors.textTertiary} textAlign="right"
            />

            <Text style={styles.label}>المستوى الأكاديمي</Text>
            <TextInput
              style={styles.modalInput} value={form.academicLevel} onChangeText={(v) => setField('academicLevel', v)}
              placeholder="مثال: السنة الثانية" placeholderTextColor={colors.textTertiary} textAlign="right"
            />
            ...
            <TextInput
              style={styles.modalInput} value={form.guardianPhone} onChangeText={(v) => setField('guardianPhone', v)}
              placeholder="05XXXXXXXX" placeholderTextColor={colors.textTertiary} textAlign="right" keyboardType="phone-pad"
            />
                ...
                <View style={styles.row}>
                  ...
                  <View style={{ flex: 1, marginHorizontal: spacing.md }}>
                    ...
                    <Text style={[typography.bodySmall, { color: colors.textTertiary }]}>
                      {item.busId?.busNumber ? `حافلة: ${item.busId.busNumber}` : '--'}
                    </Text>
                  </View>
