...
export default function EmployeeDashboard() {
  ...
  const quickActions = [
    { label: 'الطلاب', route: '/(employee)/students', icon: 'people' as const, color: colors.primary },
    { label: 'الحضور', route: '/(employee)/attendance', icon: 'checkmark-circle' as const, color: colors.secondary },
    { label: 'الاشتراكات', route: '/(employee)/subscriptions', icon: 'card' as const, color: colors.warning },
    { label: 'الإشعارات', route: '/(employee)/notifications', icon: 'notifications' as const, color: colors.info },
  ];
